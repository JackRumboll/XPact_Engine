...
namespace XPact.Core.IO
{
	...
	public class FileReference : FileSystemReference, IEquatable<FileReference>, IComparable<FileReference>
	{
		...
		/// <summary>
		/// Create a FileReference from a string. If the string is null or whitespace, returns a null FileReference.
		/// </summary>
		...
		public static FileReference? FromString(string? fileName) => String.IsNullOrWhiteSpace(fileName) ? null : new(fileName);
	...
	internal class FileReferenceJsonConverter : JsonConverter<FileReference>
	{
		...
		public override FileReference ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			if (reader.TokenType != JsonTokenType.PropertyName)
			{
				throw new JsonException("FileReference keys must be represented as JSON strings");
			}
		...
		public override void WriteAsPropertyName(Utf8JsonWriter writer, [DisallowNull] FileReference value, JsonSerializerOptions options)
		{
