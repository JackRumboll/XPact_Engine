...
__attribute__((noinline)) __attribute((naked)) bool FLongJump::SaveContext(void* Buffer)
{
	__asm
	{
...
__attribute__((noinline)) __attribute((naked)) void FLongJump::RestoreContext(void* Buffer)
{
	__asm
	{
		// rcx: Buffer, rax: Return value
