...
AUTORTFM_INTERNAL UE_AUTORTFM_FORCEINLINE void* FunctionMapLookupUsingMagicPrefix(void* OpenFn)
{
...
AUTORTFM_INTERNAL inline void* FunctionMapLookup(void* OpenFn, const char* Where)
{
...
AUTORTFM_INTERNAL auto FunctionMapLookup(TReturnType (*OpenFn)(TParameterTypes...), const char* Where)
	-> TReturnType (*)(TParameterTypes...)
{
