...
public:
    ...
    // #
    // # Consults the wall-clock timer to bound the wait. Sim-path TUs
    // # require deterministic-replay-bit-exactness; wall-clock-
    // # dependent acquire is forbidden in sim-path code.
    // #
